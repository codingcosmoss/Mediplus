...
<div class="card-header border-0 pt-5">
    <h3 class="card-title align-items-start flex-column">
        <span class="card-label font-weight-bolder text-dark">Item Buttons</span>
        <span class="text-muted mt-3 font-weight-bold font-size-sm">More than 3+ new buttons </span>
    </h3>
    <div class="card-toolbar">
        <ul class="nav nav-pills nav-pills-sm nav-dark-75">

            <li class="nav-item">
            <form action="{{ route('button.edit.show', ['id' => $id]) }}" method="GET">
    ...
    <tr>
        ...
        <td class="pl-0">
            ...
            <div>
                ...
                <a class="text-muted font-weight-bold text-hover-primary" href="#">{{ $item->link }}</a>
            </div>
        </td>
        <td class="text-right">
        ...
        <td class="text-right d-flex align-items-center pt-6 pr-0">
						...
						<form action="{{ route('button.update.show', ['id' => $id, 'slug' => $item->id]) }}" method="GET">
...
<div class="modal fade" id="exampleModalLong{{$item->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{route('button.delete' , ['id' => $id , 'slug' => $item->id])}}" method='GET'>
                                                                    <!-- @csrf -->

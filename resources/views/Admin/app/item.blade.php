...
<div class="card-header border-0 pt-5">
    ...
    <div class="card-toolbar">
        <ul class="nav nav-pills nav-pills-sm nav-dark-75">
            ...
            <li class="nav-item">
                <a class="nav-link py-2 px-4 disabled" data-toggle="tab" href="#kt_tab_pane_1_3">New Item</a>
            </li>
        </ul>
    </div>
</div>
...
<div class="card-body pt-3 pb-0">
    ...
    <tr>
        ...
        <td class="text-right">
            <span class="label label-lg label-light-primary label-inline">Lorem</span>
        </td>

...
<div class="card-header border-0 pt-5">
    ...
    <h3 class="card-title align-items-start flex-column">
        <span class="card-label font-weight-bolder text-dark">Section malumotlari</span>
        <span class="text-muted mt-3 font-weight-bold font-size-sm">More than 1+ new items </span>
    </h3>
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="card-header border-0 pt-5">
		...
		<h3 class="card-title align-items-start flex-column">
			<span class="card-label font-weight-bolder text-dark">Slider items</span>
			<span class="text-muted mt-3 font-weight-bold font-size-sm">More than 3+ new sliders </span>
		</h3>
		<div class="card-toolbar">
			<ul class="nav nav-pills nav-pills-sm nav-dark-75">
		...
		<tr>
			...
			<td class="pl-0">
				...
				<div>
					...
					<a class="text-muted font-weight-bold text-hover-primary" href="#">{{ $item->text }}</a>
				</div>
			</td>
			<td class="text-right">
				<span class="text-dark-75 font-weight-bolder d-block font-size-lg">Created at</span>
			...
			<td class="text-right">
			<span class="text-dark-75 font-weight-bolder d-block font-size-lg">Updated at</span>
				<span class="text-muted font-weight-500">{{$item->updated_at}}</span>
			</td>
			...
			<td class="text-right d-flex align-items-center pt-6 pr-0">
					...
					<form action="{{route('item.update' , ['id' => $item->id])}}" method='GET'>
							...
							<button type='button' data-toggle="modal" data-target="#exampleModalLong{{$item->id}}" class="btn btn-icon btn-light btn-hover-primary btn-sm">
								<span class="svg-icon svg-icon-md svg-icon-primary">
	...
	<div class="modal fade" id="exampleModalLong{{$item->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">

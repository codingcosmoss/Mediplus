						...
						<div class="row">
							<div class="col-12">
								<div class="single-main">
									<!-- News Head -->
									<div class="news-head">
										<img src="{{asset('')}}asset/img/blog1.jpg" alt="#">
									</div>
									<!-- News Title -->
									...
									<div class="meta">
										<div class="meta-left">
											<span class="author"><a href="#"><img src="{{asset('')}}asset/img/author1.jpg" alt="#">Naimur Rahman</a></span>
											...
											<div class="row">
												<div class="col-lg-6 col-md-6 col-12">
													<div class="single-image">
														<img src="{{asset('')}}asset/img/blog2.jpg" alt="#">
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-12">
													<div class="single-image">
														<img src="{{asset('')}}asset/img/blog3.jpg" alt="#">
													</div>
												</div>
											</div>
										</div>
								...
								<div class="blog-comments">
									...
									<div class="comments-body">
										...
										<div class="single-comments">
											<div class="main">
												<div class="head">
													<img src="{{asset('')}}asset/img/author1.jpg" alt="#"/>
												</div>
												<div class="body">
													<h4>Afsana Mimi</h4>
										...
										<div class="single-comments left">
											<div class="main">
												<div class="head">
													<img src="{{asset('')}}asset/img/author2.jpg" alt="#"/>
												</div>
												<div class="body">
													<h4>Naimur Rahman</h4>
													<div class="comment-meta"><span class="meta"><i class="fa fa-calendar"></i>March 05, 2019</span><span class="meta"><i class="fa fa-clock-o"></i>03:38 AM</span></div>
										...
										<div class="single-comments">
											<div class="main">
												<div class="head">
													<img src="{{asset('')}}asset/img/author3.jpg" alt="#"/>
												</div>
												<div class="body">
						...
						<div class="main-sidebar">
							...
							<div class="single-widget recent-post">
								...
								<div class="single-post">
									<div class="image">
										<img src="{{asset('')}}asset/img/blog-sidebar1.jpg" alt="#">
									</div>
									<div class="content">
								...
								<div class="single-post">
									<div class="image">
										<img src="{{asset('')}}asset/img/blog-sidebar2.jpg" alt="#">
									</div>
									<div class="content">
								...
								<div class="single-post">
									<div class="image">
										<img src="{{asset('')}}asset/img/blog-sidebar3.jpg" alt="#">
									</div>
									<div class="content">
